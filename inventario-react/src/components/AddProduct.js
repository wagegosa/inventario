...
class AddProduct extends Component {
    ...
    insertProduct = (event) => {
        this.context.insertProduct(event, this.nombreProducto.value, this.referencia.value, this.precio.value, this.peso.value, this.categoria.value, this.stock.value, this.fechaCreacion.value, this.fechaVentaUltima.value);
    }
